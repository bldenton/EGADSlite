...
#ifndef EGADS_BRepLib_FuseEdges_HeaderFile
#define EGADS_BRepLib_FuseEdges_HeaderFile
...
public:
  ...
  //! set vertexes to avoid being fused
  Standard_EXPORT void AvoidVertexes (const TopTools_IndexedMapOfShape& theMapVert);
...
private:
  ...
  TopTools_IndexedMapOfShape myAvoidVert;
...
#endif // EGADS_BRepLib_FuseEdges_HeaderFile
