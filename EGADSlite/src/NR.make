...
$(OBJS): %.o:	%.c ../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
		../include/egadsTypes_lite.h liteClasses.h
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -I../include -I. -I../src $< \
		-o $(ODIR)/$@

evaluateNR.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h ../util/evaluateNR.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -I../include -I. -I../src \
                ../util/evaluateNR.c -o $(ODIR)/evaluateNR.o

liteGeomNR.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h liteGeom.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -DLITE -DCUDA -I../include -I. \
		-I../src liteGeom.c -o $(ODIR)/liteGeomNR.o

liteTopoNR.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h liteTopo.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -DLITE -DCUDA -I../include -I. \
		-I../src liteTopo.c -o $(ODIR)/liteTopoNR.o

liteTris.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h ../src/egadsTris_lite.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -DLITE -I../include -I. -I../src \
                ../src/egadsTris_lite.c -o $(ODIR)/liteTris.o

liteQuads.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h ../src/egadsQuads_lite.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -I../include -I. -I../src \
                ../src/egadsQuads_lite.c -o $(ODIR)/liteQuads.o

liteTessInp.o:	../include/egadsErrors_lite.h ../src/egadsInternals_lite.h \
                ../include/egadsTypes_lite.h liteClasses.h ../src/egadsTessInp_lite.c
	$(CC) -c $(COPTS) $(DEFANL) $(DEFINE) -DLITE -I../include -I. -I../src \
                -I../util ../src/egadsTessInp_lite.c -o $(ODIR)/liteTessInp.o

emp.o:		../util/emp_lite.c
	$(CC) -c $(COPTS) $(DEFINE) -D$(ESP_ARCH) -I../include ../util/emp_lite.c \
		-o $(ODIR)/emp.o

ratLite.o:	../util/rational_lite.c
	$(CC) -c $(COPTS) $(DEFINE) -DLITE ../util/rational_lite.c \
		-o $(ODIR)/ratLite.o

liteRegQuads.o:	../util/regQuads_lite.c ../util/regQuads_lite.h
	$(CC) -c $(COPTS) $(DEFINE) -DLITE -I../include -I../util \
		../util/regQuads_lite.c -o $(ODIR)/liteRegQuads.o
