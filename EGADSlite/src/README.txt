...
EGADS library but can clearly be used by itself. ThreadTest_lite.c is code that 
...
‘limits_lite.make’ (‘limits_lite.mak’ for Windows nmake) builds a function that can be 
