...
__HOST_AND_DEVICE__ void EGlite_exactInit()
{
  REAL half;
...
__HOST_AND_DEVICE__ REAL EGlite_orienTri(REAL *pa, REAL *pb, REAL *pc)
{
...
__HOST_AND_DEVICE__ REAL EGlite_orienTet(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
