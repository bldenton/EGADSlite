...
int main(int argc, char *argv[])
{
  ...
  // take out work done on numFaces, numEdges, numVertices - REMOVE IF ABOVE SECTIONN IS REMOVED
  // ----------------------------------------------------------------------------------------------
  numFaces = 0;
  numEdges = 0.;
  numVertices = 0;
...
//    coneOrient[ii] = 0;
  ...
  // Create Complex DAG Defined directly above
