...
//extern "C" int EGlite_getTopology(const ego, ego *, int *, int *, double *, int *, ego **, int **);   // WAS EGlite_
//extern "C" int EGlite_inTopology(const ego, const double *);      // WAS EGlite_
#endif
...
#ifdef PETSC_HAVE_EGADS
    PetscCall(PetscStrcpy(args, "pYqezQY"));
#else
